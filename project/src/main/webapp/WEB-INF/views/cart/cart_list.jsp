...
<body>
	...
	<form action="<%=request.getContextPath()%>/cart/update.do"
		method="post">
				...
				<header>
					<div class="d-flex justify-content-center align-items-center pb-3">
						<div class="px-sm-5 px-2 active">
							장바구니 <span class="fas fa-check"></span>
						</div>
							...
							<div class="cart_title">
								...
								<div style="float: right;">
									<button type="button" id="btnDelete"
										class="btn btn-sm bg-dark text-dark "
										style="margin-right: 28px;">
										<a style="color: white;">전체삭제</a>
								</div>
							</div>
											...
											<div
												...
												<div class="cart_item_color cart_info_col">
													...
													<div class="cart_item_text">
														</span>${row.product_brand}</div>
												</div>
												<div class="cart_item_quantity cart_info_col">
													<div class="cart_item_title">amount</div>
													<input type="number" " name="amount" value="${row.amount}"
														style="width: 50px; border: none; margin-top: 35px;">
													<input type="hidden" name="cart_id" value="${row.cart_id}">
													<button class="btn btn-sm bg-dark text-dark">
														<a style="color: white;">변경</a>
													</button>
												</div>
	...
	<div class="cart_buttons">
		<button style="width: 162px; height: 48px;" type="button"
			class="btn btn-sm bg-light text-dark"
			onclick="location.href='<%=request.getContextPath()%>/product/list.do'">상품리스트</button>
		<a style="color: white;"><button type="button"
				class="btn btn-sm bg-dark text-dark"
				style="width: 162px; height: 48px;"
				onclick="location.href='<%=request.getContextPath()%>/order/insert.do'">결제하기</a>
		</button>
	</div>
	</div>
	</div>
