...
<script src="https://kit.fontawesome.com/6c060c00b1.js"
	crossorigin="anonymous"></script>
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/resources/image/style.css">
<meta charset="UTF-8">
...
<body>
	...
	<header>
		<div class="d-flex justify-content-center align-items-center pb-3">
			<div class="px-sm-5 px-2">장바구니</div>
			<div class="px-sm-5 px-2 active">
				결제페이지 <span class="fas fa-check"></span>
			</div>
		...
		<div class="progress">
			<div class="progress-bar bg-success" role="progressbar"
				aria-valuenow="100" aria-valuemin="50" aria-valuemax="100"></div>
		</div>
	</header>
		...
		<div class="row">
			<div
				...
				<div id="details" class="bg-white rounded pb-5"
					style="height: 600px;">
					<form action="<%=request.getContextPath()%>/order/update.do"
						method="post">

						<input type="hidden" name="order_product"
							value="${map.product_name}"> <input type="hidden"
							name="order_sum" value="${map.sumMoney}"> <input
							type="hidden" name="order_cart" value="${map.cart}"> <input
							type="hidden" name="order_code" value="${map.code}"> <input
							type="hidden" name="order_id" value="${map.id}">




						<div class="form-group" style="margin-top: 60px;">
							<label class="text-muted">이 름</label> <input type="text"
								value="${map.name}" class="form-control" name="order_name">
						</div>
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="form-group" style="margin-top: 40px;">
									...
									<div
										class="d-flex jusify-content-start align-items-center rounded p-2">
										<input type="text" name="order_addr1" id="sample6_postcode"
											value="${map.addr1}"> <span
											class="fas fa-check text-success pr-2"></span>
									</div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-group" style="margin-top: 40px;">
									<label></label> <input type="button"
										...
										style="background-color: gray; margin-top: 10px; opacity: 1; margin-top: 29px;">
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="form-group" style="margin-top: 40px;">
									...
									<div
										class="d-flex jusify-content-start align-items-center rounded p-2">
										<input type="text" type="text" name="order_addr2"
											id="sample6_address" value="${map.addr2}"> <span
											class="fas fa-check text-success pr-2"></span>
									</div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-group" style="margin-top: 40px;">
									...
									<div
										class="d-flex jusify-content-start align-items-center rounded p-2">
										<input type="text" type="text" name="order_addr3"
											id="sample6_detailAddress" value="${map.addr3}"> <span
											class="fas fa-check text-success pr-2"></span>
									</div>
								</div>
							</div>
			...
			<div
				...
				<div id="cart" class="bg-white rounded">
					...
					<div
						...
						<div class="ml-auto">
							<b class="h5"> <fmt:formatNumber value="${map.sumMoney}"
									pattern="#,###" />&nbsp;원
							</b>
						</div>
					</div>
				...
				<div class="row pt-lg-3 pt-2 buttons mb-sm-0 mb-2"
					...
					<div class="col-md-3">
						<button type="button" style="border: none;"
							onclick="location.href='<%=request.getContextPath()%>/product/list.do'">
							<div class="btn text-uppercase">목록으로</div>
						</button>
					</div>

					<div class="col-md-3" style="margin-right: 30px;">
						<button style="border: none;">
							<div class="btn text-uppercase">결제하기</div>
						</button>
