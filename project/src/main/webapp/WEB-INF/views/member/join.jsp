...
section .container .user .formbox .form input[type='button']{max-width:80px;background-color:#677eff;color:#fff;cursor:pointer}
      ...
      <h2>회원가입</h2>
       <input type="text" placeholder="아이디를 입력하세요" name="member_id">
        <input type="password" placeholder="비밀번호를 입력하세요" name="member_pw">
         ...
         <input type="text" placeholder="우편번호 입력하세요" id="sample6_postcode" name="member_addr1">
           <input type="button" onclick="sample6_execDaumPostcode()" value="주소 찾기" 
           style="background-color: black">
           </Div>
            <input type="text" placeholder="주소를 입력하세요" id="sample6_address" name="member_addr2">
               <input type="text" placeholder="상세주소 입력하세요" id="sample6_detailAddress" name="member_addr3">
                <input type="text" placeholder="이메일을 입력하세요" name="member_email">
