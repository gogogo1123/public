					...
					<div class="formbox" style="width: 550px;">
						<div class="form">
							...
							<label>상품명</label> <input type="text" placeholder="상품이름을 입력하세요"
								name="product_name" value="${list.product_name}"> <label>상품수량</label>
							<input type="number" placeholder="상품 수량을 입력하세요"
								name="product_amount" value="${list.product_amount}"> <label>상품가격</label>
							<input type="text" placeholder="상품가격을 입력하세요" name="product_price"
								value="${list.product_price}"> <label>브랜드</label>
							...
							<label>상품이미지</label> <input type="file" name="file1"> <input
								type="button" value="상품수정"
								style="background-color: black; margin-top: 100px; margin-left: 25px;"
								onclick="update()"> <input type="button" value="상품삭제"
								style="background-color: gray; margin-top: 100px; margin-left: 5px;"
								onclick="delete1()"> <img alt=""
								src="<%=request.getContextPath()%>/resources/images/${list.filename}"
								style="width: 230px; height: 200px; float: right;"> <input
								type="button" value="목록으로"
								style="background-color: gray; margin-top: 100px; margin-left: 180px;"
