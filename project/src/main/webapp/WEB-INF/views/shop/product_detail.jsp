        ...
        <div class="container" style="float: none; margin:100 auto;background-color: #white; padding: 11px;">
            <div class="row">
               ...
               <div class="col-md-6" style="float: none; margin:0 auto;">
                    <div class="image_selected" style="margin-top: 30px;"><img src="<%=request.getContextPath()%>/resources/images/${vo.filename}" style="width: max;height: max;margin: auto;"></div>
                </div>
                <div class="col-lg-6 order-3">
                    <div class="product_description">
                        <nav>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<%=request.getContextPath()%>/main.do">홈으로</a></li>
                         ...
                         <span class="product_info">7일이내 환불 가능<span><br>
                          <span class="product_info">7일이내 제품 하자시 무료배송<span><br>
                           <span class="product_info">택배 배송기간 2~3일<span><br>
                            <span class="product_info">배송료 : 2,500원 (20만원 이상 구매시 무료배송)<span>
                            </div>
                        <div>
                            <div class="row">
                                <div class="col-md-5">
